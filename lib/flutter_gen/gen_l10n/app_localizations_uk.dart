...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get addAccountToSeeProfile => 'Додайте обліковий запис, щоб побачити ваш профіль тут.';

  @override
  String get addAnonymousInstance => 'Додати сервер в анонімному режимі';
  ...
  @override
  String get allPosts => 'Всі публікації';
  ...
  @override
  String get blockCommunity => 'Заблокувати спільноту';

  @override
  String get blockInstance => 'Заблокувати сервер';

  @override
  String get blockUser => 'Заблокувати користувача';

  @override
  String get blockedCommunities => 'Заблоковані спільноти';

  @override
  String get blockedInstances => 'Заблоковані сервери';
  ...
  String browsingAnonymously(Object instance) {
    return 'Ви переглядаєте $instance анонімно.';
  }
  ...
  @override
  String get cantBlockYourself => 'Ви не можете заблокувати самі себе.';
  ...
  @override
  String get commentSavedAsDraft => 'Коментар збережено як чернетку';
  ...
  @override
  String get gettingStarted => 'Початок роботи';
  ...
  @override
  String get instance => 'Сервер';

  @override
  String instanceHasAlreadyBenAdded(Object instance) {
    return '$instance вже додано.';
  }

  @override
  String get internetOrInstanceIssues => 'Можливо, немає підключення до Інтернету, або ваш сервер тимчасово недоступний.';
  ...
  @override
  String get localPosts => 'Локальні публікації';
  ...
  @override
  String get manageAccounts => 'Керування обліковими записами';
  ...
  @override
  String get mostComments => 'Найбільш коментовані';
  ...
  @override
  String get newComments => 'З новими коментарями';

  @override
  String get newPost => 'New Post';

  @override
  String get new_ => 'Нові';
  ...
  @override
  String get noCommunitiesFound => 'Спільнот не знайдено';

  @override
  String get noCommunityBlocks => 'Ви ще не заблокували жодної спільноти.';

  @override
  String get noFavoritedCommunities => 'No favorited communities';

  @override
  String get noInstanceBlocks => 'Ви ще не заблокували жодного сервера.';
  ...
  @override
  String get noUserBlocks => 'Ви ще не заблокували жодного користувача.';
  ...
  String notValidLemmyInstance(Object instance) {
    return '$instance ймовірно, не є дійсним сервером Lemmy';
  }
  ...
  @override
  String get onlyModsCanPostInCommunity => 'Тільки модератори можуть робити публікації в цій спільноті';
  ...
  @override
  String get openInstance => 'Відкрити сторінку сервера';
  ...
  @override
  String get postSavedAsDraft => 'Публікацію збережено як чернетку';
  ...
  @override
  String get removeAccount => 'Видалити обліковий запис';

  @override
  String get removeFromFavorites => 'Remove from favorites';

  @override
  String get removeInstance => 'Видалити сервер';
  ...
  @override
  String get restoredCommentFromDraft => 'Коментар відновлено з чернетки';

  @override
  String get restoredPostFromDraft => 'Публікацію відновлено з чернетки';
  ...
  String searchCommentsFederatedWith(Object instance) {
    return 'Шукати коментарі, які перебувають в федерації з $instance';
  }

  @override
  String searchCommunitiesFederatedWith(Object instance) {
    return 'Шукати спільноти, які перебувають в федерації з $instance';
  }
  ...
  String searchPostsFederatedWith(Object instance) {
    return 'Шукати публікації, які перебувають в федерації з $instance';
  }
  ...
  String searchUsersFederatedWith(Object instance) {
    return 'Шукати користувачів, які перебувають в федерації з $instance';
  }
  ...
  @override
  String get setLongPress => 'Встановити як дію по довгому натисканню';

  @override
  String get setShortPress => 'Встановити як дію по короткому натисканню';
  ...
  @override
  String get somethingWentWrong => 'Ай, щось пішло не так!';
  ...
  @override
  String get tapToExit => 'Натисніть двічі кнопку Назад для виходу';
  ...
  @override
  String get timeoutErrorMessage => 'Сплив час очікування на відповідь від сервера.';
  ...
  @override
  String get top => 'Найбільш оцінені';

  @override
  String get topAll => 'Найбільш оцінені за весь час';

  @override
  String get topDay => 'Найбільш оцінені за сьогодні';

  @override
  String get topHour => 'Найбільш оцінені за годину';

  @override
  String get topMonth => 'Найбільш оцінені за місяць';

  @override
  String get topNineMonths => 'Top in Past 9 Months';

  @override
  String get topSixHour => 'Найбільш оцінені за 6 годин';
  ...
  @override
  String get topTwelveHour => 'Найбільш оцінені за 12 годин';

  @override
  String get topWeek => 'Найбільш оцінені за тиждень';

  @override
  String get topYear => 'Найбільш оцінені за рік';

  @override
  String get totp => 'Тимчасовий одноразовий код (необов\'язково)';

  @override
  String get translationsMayNotBeComplete => 'Please note that the translations may not be complete';

  @override
  String get trendingCommunities => 'Спільноти, що набирають популярність';

  @override
  String get trySearchingFor => 'Try searching for...';

  @override
  String get unableToFindCommunity => 'Спільноту не знайдено';
  ...
  @override
  String get unableToFindInstance => 'Сервер не знайдено';

  @override
  String get unableToFindLanguage => 'Unable to find language';

  @override
  String get unableToFindUser => 'Користувача не знайдено';
  ...
  String unableToLoadInstance(Object instance) {
    return 'Помилка завантаження інформації з $instance';
  }

  @override
  String unableToLoadPostsFrominstance(Object instance) {
    return 'Помилка завантаження публікацій з $instance';
  }
