...
import 'package:uniun/posts/widgets/comment_card.dart';
import 'package:uniun/posts/widgets/post_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PostBloc, PostState>(
      listener: (context, state) {
        ...
        } else if (state.newlyCreatedCommentId != null && state.comments.first.commentEntity?.commentID == state.newlyCreatedCommentId) {
                ...
                children: [
                  ...
                  if (index != widget.comments.length + 1)
                    CommentCard(
                      ...
                      collapsed: collapsedCommentSet.contains(widget.comments[index - 1].commentEntity!.commentID) || widget.level == 2,
