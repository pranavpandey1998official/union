...
class _$AuthUserModelImpl extends _AuthUserModel {
  const _$AuthUserModelImpl(
      ...
      @JsonKey(name: 'walletID') required this.walletID,
  ...
  @override
  String toString() {
    return 'AuthUserModel(id: $id, name: $name, email: $email, username: $username, walletID: $walletID, token: $token)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, username, walletID, token);
...
abstract class _AuthUserModel extends AuthUserModel {
  const factory _AuthUserModel(
          ...
          @JsonKey(name: 'walletID') required final int walletID,
