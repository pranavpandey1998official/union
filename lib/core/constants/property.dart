...
class PropertyConstant {
  ...
  static const int labelBetweenSpace = 10;

  //FONT SIZE
  static const double headlineSmallFontSize = 14.0;
  static const double headlineMediumFontSize = 16.0;
  static const double headlineLargeFontSize = 22.0;

  static const double displaySmallFontSize = 14.0;
  static const double displayMediumFontSize = 15.0;
  static const double displayLargeFontSize = 15.0;

  static const double titleSmallFontSize = 14.0;
  static const double titleMediumFontSize = 16.0;
  static const double titleLargeFontSize = 18.0;

  static const double bodySmallFontSize = 18.0;
  static const double bodyMediumFontSize = 14.0;
  static const double bodyLargeFontSize = 14.0;

  static const double labelSmallFont = 12.0;
  static const double labelMediumFont = 15.0;
  static const double labelLargeFont = 14.0;
