...
class CreatePostPage extends StatefulWidget {
  ...
  final CommunityEntity? communityView;
...
class CommunitySelector extends StatefulWidget {
  ...
  final Function(CommunityEntity) onCommunitySelected;
...
class _CommunitySelectorState extends State<CommunitySelector> {
  int? _communityId;
  CommunityEntity? _communityView;
    ...
    return Transform.translate(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              CommunityIcon(community: _communityView, radius: 16),
              const SizedBox(width: 12),
              _communityId != null
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('${_communityView?.name} '),
                      ],
                    )
                  : SizedBox(
                      height: 36,
