...
void handleLinkLongPress(BuildContext context, UniunState state, String text, String? url) {
...
Future<void> handleLinkTap(BuildContext context, UniunState state, String text, String? url) async {
